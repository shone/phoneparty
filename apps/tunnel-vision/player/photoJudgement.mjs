...
routes['#apps/tunnel-vision/photo-judgement'] = async function photoJudgement({params, waitForEnd, listenForChannel}) {
  ...
  listenForChannel((channel, channelName) => {
    ...
    panelB.querySelector('img').src = `/apps/tunnel-vision/things/${thing}.svg`;
