...
routes['#apps/tunnel-vision/photo-taking'] = async function photoTaking({params, waitForEnd, listenForChannel}) {
  ...
  photoScreen.querySelector('.goal img').src = `/apps/tunnel-vision/things/${thing}.svg`;
  ...
  takePhotoButton.onclick = async function() {
    ...
    if (video.srcObject) {
      ...
      testImage.src = `/apps/tunnel-vision/test_photos/${randomInArray(['1', '2', '3', '4'])}.jpg`;
